...
$string['configdigesttype'] = 'This defines whether users should get a single digest or separate email digest for each course.';
...
$string['digesttypefull'] = 'Single email digest';
$string['digesttypepercourse'] = 'Separate email digest per course';
$string['digestsentusers'] = 'Email digests successfully sent to {$a} users.';
$string['digestsentusermails'] = 'Email digests sent: {$a}';
